...
if (window.location.href.indexOf("new_session") > -1) {
    var checkCodeStatus = function checkCodeStatus() {
        $.ajax({ url: "/checkCodeStatus?code=" + document.getElementById('session_code').innerHTML, success: function success(result) {
                if (result == "connected") {
...
if (window.location.href.indexOf("connected_session") > -1) {
    var checkAirplaneStatus = function checkAirplaneStatus() {
        $.ajax({ url: "/checkAirplaneMode?code=" + document.getElementById('session_code').innerHTML, success: function success(result) {
                if (result == "correct") {
